...
<body class="bg-surface font-sans text-gray-800 antialiased flex h-screen overflow-hidden">
    ...
    <aside id="sidebar"
        ...
        <nav class="flex-1 overflow-y-auto py-4 space-y-1 custom-scrollbar">
            ...
            <div class="px-6 mb-2 mt-6">
                <span class="text-xs font-bold text-gray-400 uppercase tracking-wider">Akun</span>
            </div>

            <a href="{{ route('profile.edit') }}"
                class="sidebar-item flex items-center gap-3 px-6 py-3 text-sm font-medium hover:bg-white/5 transition-all {{ request()->routeIs('profile.edit') ? 'sidebar-active' : 'text-gray-300' }}">
                <svg class="w-5 h-5 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="absolute right-0 top-full pt-2 w-48 hidden group-hover:block z-50">
                        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                            <div class="px-4 py-3 border-b border-gray-50 bg-gray-50">
                                ...
                                <p class="text-sm font-bold text-gray-900 truncate mb-1">{{ auth()->user()->email ??
                                    'admin@email.com' }}</p>
                                <a href="{{ route('profile.edit') }}"
                                    class="text-[10px] text-primary font-bold hover:underline">Pengaturan Profil</a>
                            </div>
